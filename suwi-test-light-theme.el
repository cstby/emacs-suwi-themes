...
(defconst suwi-test-light-color-alist
  '((pink-0 . "#fff8ff")
    (violet-0 . "#43204d")
    (violet-2 . "#b2166b")
    (pink-2 . "#f4cae8")
    ...
    (variable . "#6a6dff")
    (constant . "#ff5e89"))
  "Theme-specific color catalog entries for `suwi-test-light'.")

(defconst suwi-test-light-palette-mapping-overrides
  '()
...
(defconst suwi-test-light-palette
  (let ((color-table (suwi-build-light-color-table suwi-test-light-color-alist)))
    (suwi-build-light-palette color-table suwi-test-light-palette-mapping-overrides)))
